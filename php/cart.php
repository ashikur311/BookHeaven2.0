...
<body>
                        ...
                        <div class="cart-item" data-cart-id="<?= $item['id'] ?>" data-book-id="<?= $item['book_id'] ?>">
                            ...
                            <div class="cart-item-details">
                                ...
                                <div class="cart-item-actions">
                                    ...
                                    <button class="wishlist-item" data-cart-id="<?= $item['id'] ?>"
                ...
                <?php else: ?>
                    <div class="empty-cart">
                        ...
                        <button class="btn btn-primary" style="margin-top: 20px;"
                            onclick="window.location.href='/BookHeaven2.0/index.php'">
            ...
            <?php if (count($cart_items) > 0): ?>
                <div class="cart-summary">
                    ...
                    <div class="summary-row">
                        <span>Subtotal (<?= $totals['item_count'] ?>
                            <?= $totals['item_count'] === 1 ? 'item' : 'items' ?>)</span>
                    ...
                    <div class="address-input">
                        ...
                        <textarea id="shippingAddress"
                            placeholder="Enter your shipping address"><?= htmlspecialchars($user_address) ?></textarea>
                    </div>
    ...
    <div class="modal" id="confirmationModal">
        <div class="modal-content">
            ...
            <!-- Payment Method Section - Only shown for online payment -->
            <div class="payment-method" id="onlinePaymentSection" style="display: none;">
                ...
                <div class="payment-options">
                    ...
                    <div class="payment-option" data-method="card">
                        <i class="far fa-credit-card" style="color: #0061a8;"></i>
                ...
                <div class="payment-details" id="bkashDetails">
                    <p>You'll be redirected to bKash payment page</p>
                </div>
